...
public class EmployeeController {
    ...
    public  ResponseEntity<EmployeeResponse> update(@PathVariable int employeeNumber @RequestBody EmployeeRequest employeeRequest) throws EmployeeNotFoundException {
